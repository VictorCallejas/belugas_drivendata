...
def vit_concat():
    return CaiT(image_size=256, patch_size=32, num_classes=1, dim=192, depth=2, cross_depth=2, cls_depth=2, heads=12, mlp_dim=512, dim_head = 64, dropout = 0., emb_dropout = 0.)